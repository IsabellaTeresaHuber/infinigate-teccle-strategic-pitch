  	...
  	extend: {
        ...
        cloudflare: '#F38020',
  		...
  		boxShadow: {
  			...
  			'glow-lg': '0 0 40px -10px rgba(243, 128, 32, 0.3)',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px rgba(243, 128, 32, 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px rgba(243, 128, 32, 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
        ...
        'gradient-brand': 'linear-gradient(135deg, #E30613 0%, #F38020 100%)',
